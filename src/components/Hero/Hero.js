            ...
            <div className="relative z-30 flex flex-col items-center w-full pt-12">
                ...
                <div className="relative mt-9  ">
                    <input
                        ...
                        placeholder="Address, city, zip code or district"
                    />
                    <div
                        className="absolute w-[2.7rem] h-[2.7rem] rounded-full  bg-[#e20112] top-[0.4rem] right-1 flex items-center justify-center">
